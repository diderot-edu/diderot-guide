...
\begin{gram}[Inter-Book References]
You can make references between books.  For example recitation book
could refer to a label in the textbook by using the syntax
%
\lstinline`\href{TB/def:shortest-paths}`,
%
 where \lstinline`TB` is the label of the book being referred to.
\end{gram}
