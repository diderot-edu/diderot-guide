...
label thes problem as \lstinline`prb:fib`.  You can then include the
same exam problem in two different exams within the same book.
%
%
To help in authoring, we recommended giving each chapter a unique
label, and prepending each label in that chapter, with the chapter
label.
