...
%
This is important, because it impacts how the effects should be propagated to the users.  
...
These challenges are not insurmountable but we have at this time decided to proceed with this principle: a chapter will not be updated after it is released.
\end{gram}
...
\begin{gram}[Fixing Errors After Release]
