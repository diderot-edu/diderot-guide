...
\begin{cluster}
\label{grp:grm:quiz::time-limit-due-date-and-number-of-submissions}

\begin{gram}[Time Limit, Due Date, and Number of Submissions]
\label{grm:quiz::time-limit-due-date-and-number-of-submissions}
...
\begin{cluster}
\label{grp:xmpl:quiz::multiple-choice}

\begin{example}[Multiple Choice]
\label{xmpl:quiz::multiple-choice}
...
\begin{cluster}
\label{grp:xmpl:quiz::fill-in-the-blanks}

\begin{example}[Fill in the blanks]
\label{xmpl:quiz::fill-in-the-blanks}
...
\begin{cluster}
\label{grp:xmpl:quiz::code-fill-in-the-blanks}

\begin{example}[Code Fill in the Blanks]
\label{xmpl:quiz::code-fill-in-the-blanks}
